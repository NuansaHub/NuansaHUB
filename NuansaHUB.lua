...
MinLogo.Position = UDim2.new(0, 20, 0.5, -25) -- Posisi di kiri tengah layar
MinLogo.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
MinLogo.Visible = false -- Sembunyi saat menu utama terbuka
MinLogo.Image = "rbxassetid://123456789" -- Ganti dengan ID Logo kamu
Instance.new("UICorner", MinLogo).CornerRadius = UDim.new(0, 10)
local Stroke = Instance.new("UIStroke", MinLogo)
Stroke.Color = Color3.fromRGB(0, 255, 200)
Stroke.Thickness = 2

-- Tambahkan Teks jika logo tidak ada
local MinText = Instance.new("TextLabel", MinLogo)
MinText.Size = UDim2.new(1, 0, 1, 0)
MinText.BackgroundTransparency = 1
MinText.Text = "A" -- Huruf "A" untuk Alpha
MinText.TextColor3 = Color3.fromRGB(0, 255, 200)
MinText.Font = Enum.Font.GothamBold
MinText.TextSize = 20

-- Tombol Minimize (Di dalam Menu Utama)
local MinBtn = Instance.new("TextButton", Main)
MinBtn.Size = UDim2.new(0, 30, 0, 30)
MinBtn.Position = UDim2.new(1, -70, 0, 5) -- Di sebelah tombol X
MinBtn.Text = "-"
...
-- Biarkan Logo Kecil Bisa Digeser (Draggable)
